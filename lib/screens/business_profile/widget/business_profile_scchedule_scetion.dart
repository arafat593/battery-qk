...
class BusinessProfileSecheduleScetion extends StatelessWidget {
  ...
  const BusinessProfileSecheduleScetion({super.key, this.businessHours});
          ...
          children: [
            ...
            if (businessHours == null || businessHours!.isEmpty)
              ...
              ...businessHours!.map((hour) {
                ...
                if (!isClosed) {
                  final String opens =
                      hour['opens_at_formatted']?.toString() ??
                      hour['opens_at']?.toString() ??
                      "";
                  final String closes =
                      hour['closes_at_formatted']?.toString() ??
                      hour['closes_at']?.toString() ??
                      "";
